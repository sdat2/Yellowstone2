...
#tff3 - filterconst = 1.0, fmin = 0.01, fmax = 0.5, filltype = 'gauss'
#jgf1 - filterconst = 0.4, fmin = 0.01, fmax = 0.5, filltype = 'gauss'
...
for stadir in stations:
    ...
    print('This station has ',len(stalist), ' pickle files in its /Fresh_copies directory')
